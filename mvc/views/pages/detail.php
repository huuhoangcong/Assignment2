    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate">
                <a class="image-popup"><img src="<?php echo $rooms[0]['Hinh']; ?>"
                        class="img-fluid" alt="Colorlib Template"></a>
            </div>
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                <h3>
                    <?php echo $rooms[0]['Ten']; ?>
                </h3>
                <p class="price"><span>
                    <?php if ($rooms[0]['MaMon'][0] == 'D') {
                        foreach ($data['rooms'] as $room):
                            echo $room['Size'] . " : " . $room['DonGia'] ."VND";
                            echo "<br>";
                        endforeach;
                    }
                    else {
                        echo "Price: " . $rooms[0]['DonGia'] ."VND/phan";
                        echo "<br>";
                        $count = 1;
                        foreach ($data['rooms'] as $room):
                            echo "<h4>Served time " . $count . ": " . $room['BatDau'] . " to " . $room['KetThuc'] ."</h4>";
                            // echo "<br>";
                            $count++;
